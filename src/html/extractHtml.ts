      ...
      <div style="margin-bottom: 10px;">
        ...
        <table style="width: 100%; border: 1px solid gainsboro">
          <tr>
            ...
            <th style="color: #AA7339; padding: 12px; text-align: left">Documento</th>
            <th style="color: #AA7339; padding: 12px; text-align: left">Order ID</th>
            <th style="color: #AA7339; padding: 12px; text-align: left">Valor</th>
            <th style="color: #AA7339; padding: 12px; text-align: left">Saldo</th>
          </tr>`;
    ...
    data[date].forEach((transaction) => {
      transactionsHtml += `
        <tr>
          ...
          <td style="padding: 8px">${transaction.orderId}</td>
          <td style="padding: 8px; color: ${
            transaction.valor.includes("-") ? "#FF1F1F" : "#12EA34"
          }"><b ${
        transaction.status === "pix_error"
          ? 'style="text-decoration: line-through"'
          : ""
      }>${transaction.valor}</b></td>
          <td style="padding: 8px"><b>${transaction.saldo}</b></td>
        </tr>`;
    });
